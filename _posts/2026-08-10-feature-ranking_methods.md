...
- Reduces approximately **1,500 recorded signals** to a focused set of **50-100 high-impact features**. Normally the analysis is done by domain experts to list the variables, with this approach fresh engineers can do the initial data analysis and second level of filtration can be done by the experts.
